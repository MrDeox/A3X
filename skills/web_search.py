...
def web_search(query: str) -> dict:
    ...
    if not TAVILY_API_KEY:
        ...
        return {
            ...
            "data": {
                "message": "Tavily API key not configured. Web search is disabled."
            },
        }
    ...
    if search_results:
        ...
        logger.warning(
            "Tavily search failed or returned no results. Falling back to stub."
        )
    ...
    if not search_results:
        ...
        return {
            ...
            "action": "web_search_failed",
            "data": {
                "message": f"Web search failed to retrieve results for query: '{query}' (Method: {search_method})"
            },
        }
