...
from skills.manage_files import append_to_file
...
def mock_open_func(mocker):
    # return mocker.patch("builtins.open", mock_open()) # F821 - Incorrect usage
    # Patch builtins.open and return the mock object itself
...
async def test_append_to_file_success(mock_validate, tmp_path, mock_path_object):
    ...
    mock_open.assert_called_once_with(
        resolved_path_mock._real_path, "a", encoding="utf-8"
    )
